...
} from "../../store/apiquery/categoryApiSlice";
            ...
            <tr className="p-3" key={category.id}>
              ...
              <td className="fw-bold d-flex gap-2 justify-content-center">
                <a
                  ...
                  onClick={(e) => parseCategory(category)}
                  title="View"
                >
                ...
                <a
                  ...
                  title="Delete"
                  onClick={(e) => deleteItem(Number(category.id))}
                >
  ...
  return (
    <div className="text-black">
      ...
      <div className="subPartMain">
        {page === "list" ? (
          <ListOfCategories
            setCategory={setCurrentCatetegory}
            setPage={setPage}
          />
        ) : (
