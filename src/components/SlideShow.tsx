...
const SlideShow = (props: { options?: {} }) => {
  const slides = {
    data: [
      {
        id: 1,
        image: "Dashboard Slide Text-1683381310.jpg",
        text: "Dashboard Slide Text",
        created_at: "2023-05-06T15:55:10.000000Z",
        updated_at: "2023-05-06T15:55:10.000000Z",
      },
    ],
  };
